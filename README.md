Bring your own key version is on the feat-byok branch. The release for it is linked [here](https://github.com/vdaita/superdocs/releases/tag/v0.0.7-byok-alpha).
